...
public class ApiRequestVo extends BaseModel implements Serializable {
    private ApiResponseVo apiResponseVo;

    private List<ApiResponseFieldVo> fieldVos;

    private List<ApiRequestParameterVo> parameterVos;

    private String projectName;

    private String moduleName;

    public ApiResponseVo getApiResponseVo() {
    ...
    public List<ApiResponseFieldVo> getFieldVos() {
        return fieldVos;
    }

    public void setFieldVos(List<ApiResponseFieldVo> fieldVos) {
    ...
    public List<ApiRequestParameterVo> getParameterVos() {
        return parameterVos;
    }

    public void setParameterVos(List<ApiRequestParameterVo> parameterVos) {
    ...
    public boolean equals(Object that) {
        ...
        ApiRequestVo other = (ApiRequestVo) that;
